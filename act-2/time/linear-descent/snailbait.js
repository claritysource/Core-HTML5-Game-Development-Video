...
var SnailBait =  function () {
   ...
   this.jumpBehavior = {
      ...
      isDoneAscending: function (sprite) {
         return sprite.ascendStopwatch.getElapsedTime() >
      ...
      isDoneDescending: function (sprite) {
         return sprite.descendStopwatch.getElapsedTime() > 
                sprite.JUMP_DURATION/2;
      },
...
SnailBait.prototype = {
   ...
   equipRunnerForJumping: function () {
      ...
      this.runner.ascendStopwatch = new Stopwatch();
      this.runner.descendStopwatch = new Stopwatch();
